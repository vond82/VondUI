...
This is *very much* a WIP and so far only AST, SGE, DNC, VPR and PLD are supported. More jobs will be added shortly, focus has been on making updates to the standard version of the UI before continuing with the NieR offshoot.
